...
var Dukpt = function () {
    ...
    _createClass(Dukpt, [{
        ...
        value: function generateDukptSessionKey(ipek, ksn) {
            ...
            return this._createDataKeyHex(ipek, ksn);
        }
    }, {
        ...
        value: function _createDataKeyHex(ipek, ksn) {
            ...
            // left half:
            var left = this._des(this._EDE3KeyExpand(maskedPEK), maskedPEK.substring(0, 8), true, CBC, iv, null);

            // right half:
            var right = this._des(this._EDE3KeyExpand(maskedPEK), maskedPEK.substring(8), true, CBC, iv, null);
        ...
        value: function _createIPEK(bdk, ksn) {
            ...
            var cipher = this._des(key, maskedKSN, true, /* encrypt */
            CBC, iv, null);
        ...
        value: function _generateKey(key, ksn) {
            ...
            var right = this._encryptRegister(key, ksn);
        ...
        value: function _encryptRegister(key, reg) {
            ...
            var desEncrypted = this._des(top8, bottom8xorKSN, true, /* encrypt */
            CBC, iv, null);
        ...
        value: function _deriveKeyHex(ipek, ksn) {
            ...
            var dk = this._deriveKey(binipek, binksn);
        ...
        key: '_des_createKeys',
        value: function _des_createKeys(key) {
